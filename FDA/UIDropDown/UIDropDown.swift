...
extension UIDropDown: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        //cell!.textLabel!.font = UIFont(name: optionsFont ?? font ?? cell!.textLabel!.font.fontName, size: 15)
        cell!.textLabel!.font = UIFont.systemFont(ofSize: title.font.pointSize)
...
extension UIDropDown: UITableViewDelegate {
    ...
    public func didSelectRowAt (option:Int){
        
        selectedIndex = option
        
        title.alpha = 0.0
        title.text = "\(self.options[option])"
...
//        }
        ...
        privatedidSelect("\(self.options[option])", selectedIndex!)
    }
}
